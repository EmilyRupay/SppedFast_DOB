...
/**
 * Demo original de la Semana 3: simula el sistema de reparto SpeedFast
 * demostrando polimorfismo, abstracción e interfaces (despacho,
 * cancelación e historial) sin concurrencia.
 *
 * <p>Se conserva como referencia del diseño orientado a objetos sobre el
 * que se construye la Semana 5. La clase que ahora se ejecuta como punto
 * de entrada principal del proyecto es {@link Main}, que agrega la capa
 * de concurrencia (hilos y sincronización) sobre la zona de carga.</p>
 */
public class DemoPolimorfismoSemana3 {
